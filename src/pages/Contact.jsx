...
const Contact = () => {
  return (
    <>
      <section className="container mx-auto px-20 relative z-10 overflow-hidden bg-white py-20 dark:bg-dark lg:py-30">
        <div className="container">
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-142.5 lg:mb-0">
                <h2 className="mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  DATOS DE CONTACTO
                </h2>
                
                <div className="mb-8 flex w-full max-w-92.5">
                  <div className="mr-6 flex h-15 w-full max-w-15 items-center justify-center overflow-hidden rounded bg-primary/5 text-primary sm:h-17.5 sm:max-w-17.5">
                    <svg
                      width="32"
                      height="32"
                      viewBox="0 0 32 32"
                ...
                <div className="mb-8 flex w-full max-w-92.5">
                  <div className="mr-6 flex h-15 w-full max-w-15 items-center justify-center overflow-hidden rounded bg-primary/5 text-primary sm:h-17.5 sm:max-w-17.5">
                    <img src={emailcon} alt="Email Icon" width="32" height="32" />
                  </div>
                  <div className="w-full">
                    <h4 className="mb-1 text-xl font-bold">
                      Email Address
